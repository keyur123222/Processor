...
#
# Generated by export_simulation on Tue Oct 01 18:57:28 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './uproc_top_level.sh' script.

./uproc_top_level.sh -reset_run
...
./uproc_top_level.sh -noclean_files

For more information on the script, please type './uproc_top_level.sh -help'.
