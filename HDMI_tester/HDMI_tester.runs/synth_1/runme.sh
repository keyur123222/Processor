...
HD_PWD='C:/Users/keyur/Documents/Vivado/HDMI_tester/HDMI_tester.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Tester_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_Tester_wrapper.tcl
