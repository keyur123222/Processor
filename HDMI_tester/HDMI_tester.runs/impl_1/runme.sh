...
HD_PWD='C:/Users/keyur/Documents/Vivado/HDMI_tester/HDMI_tester.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Tester_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_Tester_wrapper.tcl -notrace
