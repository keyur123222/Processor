...
--               c:/Users/keyur/Documents/Vivado/Processor/Processor.gen/sources_1/bd/uproc_top_level/ip/uproc_top_level_vga_ctrl_0_0/uproc_top_level_vga_ctrl_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of uproc_top_level_vga_ctrl_0_0_vga_ctrl is
  ...
  signal \hcounter[9]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \hcounter[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \hcounter[9]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \hcounter[9]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \hcounter[9]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \hcounter[9]_i_6\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \vcounter[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \vcounter[1]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \vcounter[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \vcounter[7]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \vcounter[9]_i_7\ : label is "soft_lutpair4";
...
\hcounter[9]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\hcounter[9]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\hcounter[9]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\vcounter[9]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\vcounter[9]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\vcounter[9]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
entity uproc_top_level_vga_ctrl_0_0 is
  ...
  attribute x_core_info of uproc_top_level_vga_ctrl_0_0 : entity is "vga_ctrl,Vivado 2021.1";
