...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, en, rst, rID1, rID2, wr_en1, wr_en2, regrD1, regrD2, 
  regwD1, regwD2, fbRST, fbAddr, fbDin1, fbDout1, fbWr_en, irAddr, irWord, dAddr, d_wr_en, dOut, dIn, aluA, 
  aluB, aluOp, aluResult, ready, newChar, send, charRec, charSend)
