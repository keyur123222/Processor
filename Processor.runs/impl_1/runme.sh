...
HD_PWD='C:/Users/keyur/Documents/Vivado/Processor/Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uproc_top_level_wrapper.tcl -notrace
