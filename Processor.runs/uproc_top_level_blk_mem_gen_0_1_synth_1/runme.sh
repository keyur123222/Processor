...
HD_PWD='C:/Users/keyur/Documents/Vivado/Processor/Processor.runs/uproc_top_level_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uproc_top_level_blk_mem_gen_0_1.tcl
