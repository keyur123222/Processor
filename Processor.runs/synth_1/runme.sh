...
HD_PWD='C:/Users/keyur/Documents/Vivado/Processor/Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uproc_top_level_wrapper.tcl
