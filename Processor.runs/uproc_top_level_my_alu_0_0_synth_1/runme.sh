...
HD_PWD='C:/Users/keyur/Documents/Vivado/Processor/Processor.runs/uproc_top_level_my_alu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level_my_alu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uproc_top_level_my_alu_0_0.tcl
